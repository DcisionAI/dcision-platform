...
export default function JobShop() {
  return (
    <Layout>
              ...
              <div className="relative w-64 h-64">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center">
                  <svg className="w-48 h-48 text-blue-200/20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" className="animate-pulse" />
                  </svg>
                </div>
              </div>

              <h1 className="text-3xl font-bold text-docs-text">Job Shop Scheduling</h1>
              <p className="text-docs-muted text-center max-w-md">
                Our job shop scheduling solution is under development. We're building sophisticated algorithms to optimize your manufacturing operations and minimize makespan.
              </p>
