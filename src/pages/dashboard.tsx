        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="rounded-xl p-6 shadow border min-h-[100px] w-full bg-[#ede9dd] border-[#f4f1ea] text-[#18181b] dark:bg-[#1C2128] dark:border-[#21262D] dark:text-[#E7E9EB]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className={`text-base font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>GPT-4 Turbo</h3>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Business Context Analysis</h4>
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Decision Insights</h4>
                          <div className="text-right text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Decision Frameworks</h4>
                          <div className="text-right text-sm">
              ...
              <div className="rounded-xl p-6 shadow border min-h-[100px] w-full bg-[#ede9dd] border-[#f4f1ea] text-[#18181b] dark:bg-[#1C2128] dark:border-[#21262D] dark:text-[#E7E9EB]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className={`text-base font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Claude 3 Opus</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Knowledge Base</h4>
                          <div className="text-right text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Data Intelligence</h4>
                          <div className="text-right text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'}`}>Decision Quality Analysis</h4>
                          <div className="text-right text-sm">
          ...
          {tab === 'System Health' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="rounded-xl p-6 shadow border min-h-[100px] bg-[#ede9dd] border-[#f4f1ea] text-[#18181b] dark:bg-[#1C2128] dark:border-[#21262D] dark:text-[#E7E9EB]">
                <h3 className={`text-base font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'} mb-4`}>Core Services</h3>
                <div className="space-y-4">
              ...
              {/* Integration Points */}
              <div className="rounded-xl p-6 shadow border min-h-[100px] bg-[#ede9dd] border-[#f4f1ea] text-[#18181b] dark:bg-[#1C2128] dark:border-[#21262D] dark:text-[#E7E9EB]">
                <h3 className={`text-base font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'} mb-4`}>Integration Points</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-xs text-docs-muted mb-2 dark:text-gray-400">
          ...
          {tab === 'Agents' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Active Agents */}
              <div className="rounded-xl p-6 shadow border min-h-[100px] bg-[#ede9dd] border-[#f4f1ea] text-[#18181b] dark:bg-[#1C2128] dark:border-[#21262D] dark:text-[#E7E9EB]">
                <h3 className={`text-base font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'} mb-4`}>Active Agents</h3>
                <div className="space-y-6">
                  {/* Data Processing Agents */}
                  <div>
                    <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'} mb-2`}>Data Processing</h4>
                  ...
                  <div>
                    <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'} mb-2`}>Decision Making</h4>
                    <div className="space-y-2">
                  ...
                  <div>
                    <h4 className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-docs-text'} mb-2`}>Insight Generation</h4>
                    <div className="space-y-2">
