...
const systemStatus = {
  core: [
    ...
    { name: 'Data Pipeline', status: 'healthy', uptime: '99.8%', latency: '120ms' },
    { name: 'Model Service', status: 'healthy', uptime: '99.9%', latency: '65ms' },
    { name: 'API Gateway', status: 'healthy', uptime: '99.9%', latency: '25ms' }
  ],
  integrations: [
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
          ...
          <div className="bg-docs-section rounded-xl p-6 flex flex-col items-start shadow border border-docs-section-border min-h-[120px]">
            ...
            <span className="text-2xl font-bold text-docs-text">
              {analyticsLoading ? '—' : analyticsError ? '!' : analytics?.total_sessions ?? 0}
            </span>
          </div>
          <div className="bg-docs-section rounded-xl p-6 flex flex-col items-start shadow border border-docs-section-border min-h-[120px]">
            ...
            <span className="text-2xl font-bold text-docs-text">
              {analyticsLoading ? '—' : analyticsError ? '!' : analytics?.total_prompts ?? 0}
            </span>
          </div>
          <div className="bg-docs-section rounded-xl p-6 flex flex-col items-start shadow border border-docs-section-border min-h-[120px]">
            ...
            <span className="text-2xl font-bold text-docs-text">
              {analyticsLoading ? '—' : analyticsError ? '!' : analytics?.total_responses ?? 0}
            </span>
          </div>
          <div className="bg-docs-section rounded-xl p-6 flex flex-col items-start shadow border border-docs-section-border min-h-[120px]">
            ...
            <span className="text-2xl font-bold text-docs-text">
              {analyticsLoading ? '—' : analyticsError ? '!' : analytics?.total_decisions ?? 0}
            </span>
          </div>
          {/* MCP Server Status */}
          <div className="bg-docs-section rounded-xl p-6 flex flex-col items-start shadow border border-docs-section-border">
            ...
            <div className="flex flex-col">
              <span className="text-docs-muted text-sm mb-1">MCP Server</span>
              <div className="flex items-center gap-2">
                <span className="text-2xl font-bold text-docs-text">Active</span>
                <span className="text-xs text-green-400 bg-green-400/10 px-2 py-1 rounded-full">99.9% Uptime</span>
              </div>
            </div>
          </div>
        ...
        {/* System Status Row */}
        <div className="mt-12">
          <h2 className="text-xl font-semibold text-docs-text mb-6">System Health</h2>
