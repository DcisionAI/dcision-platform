  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto p-8">
        {/* Header */}
        <h1 className="text-xl font-bold text-docs-heading mb-4">Dashboard</h1>
        {/* Summary Cards */}
        ...
        {/* Tabs */}
        <div className="px-4 bg-docs-section">
          <Tabs
            tabs={TABS}
            value={tab}
            onChange={setTab}
        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-docs-section rounded-xl p-6 shadow border border-docs-section-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-docs-text">GPT-4 Turbo</h3>
                    <p className="text-xs text-docs-muted">gpt-4-0125-preview</p>
                  </div>
                </div>
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-docs-text">Business Context Analysis</h4>
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-docs-text">Decision Insights</h4>
                          <div className="text-right text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-docs-text">Decision Frameworks</h4>
                          <div className="text-right text-sm">
              ...
              <div className="bg-docs-section rounded-xl p-6 shadow border border-docs-section-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-docs-text">Claude 3 Opus</h3>
                    <p className="text-xs text-docs-muted">claude-3-opus-20240229</p>
                  </div>
                </div>
                <div className="space-y-4">
                  {/* Knowledge Base Row */}
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-docs-text">Knowledge Base</h4>
                          <div className="text-right text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-docs-text">Data Intelligence</h4>
                          <div className="text-right text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-1">
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="text-sm font-semibold text-docs-text">Decision Quality Analysis</h4>
                          <div className="text-right text-sm">
          ...
          {tab === 'System Health' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Core Services */}
              <div className="bg-docs-section rounded-xl p-6 shadow border border-docs-section-border">
                <h3 className="text-base font-semibold text-docs-text mb-4">Core Services</h3>
                <div className="space-y-4">
              ...
              {/* Integration Points */}
              <div className="bg-docs-section rounded-xl p-6 shadow border border-docs-section-border">
                <h3 className="text-base font-semibold text-docs-text mb-4">Integration Points</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-xs text-docs-muted mb-2">
          ...
          {tab === 'Agents' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Active Agents */}
              <div className="bg-docs-section rounded-xl p-6 shadow border border-docs-section-border">
                <h3 className="text-base font-semibold text-docs-text mb-4">Active Agents</h3>
                <div className="space-y-6">
                  {/* Data Processing Agents */}
                  <div>
                    <h4 className="text-sm font-semibold text-docs-text mb-2">Data Processing</h4>
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-docs-text mb-2">Decision Making</h4>
                    <div className="space-y-2">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-docs-text mb-2">Insight Generation</h4>
                    <div className="space-y-2">
